...
from src.exceptions import PieceNotFoundException, TooMuchPiecesInTheDeckException, NotEnoughPiecesInTheDeckException
...
class DeckTest(unittest.TestCase):
    ...
    def test_create(self) -> None:
        with self.assertRaises(TooMuchPiecesInTheDeckException):
