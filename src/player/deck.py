...
from ..exceptions import PieceNotFoundException, TooMuchPiecesInTheDeckException, NotEnoughPiecesInTheDeckException
...
class Deck:
    ...
    def __init__(self, pieces: List[Piece]) -> None:
        ...
        Raises:
            TooMuchPiecesInTheDeckException: If more than 21 pieces are provided.
            NotEnoughPiecesInTheDeckException: If fewer than 21 pieces are provided.
        """
        if len(pieces) > self.MAX_SIZE:
            raise TooMuchPiecesInTheDeckException()
        if len(pieces) < self.MAX_SIZE:
    ...
    def is_full(self) -> bool:
        ...
        """
        return len(self.pieces) == self.MAX_SIZE
